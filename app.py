...
# --- CSS Injection (Global Roboto & Slider-Matching Button) ---
st.markdown("""
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700&display=swap');
        
        /* Force Roboto globally across Streamlit's shadow DOM */
        html, body, .stApp, [class*="css"], div, span, p, input, button, select, label {
            ...
            with st.spinner("Triangulating..."):
                ...
                if not geo_a or not geo_b:
                    ...
                    if not final_list:
                        ...
                        # Success: Store results and trigger UI collapse
...
if st.session_state.results and not st.session_state.expander_open:
    ...
    st.info("Enter two locations to find the perfect middle ground.")
